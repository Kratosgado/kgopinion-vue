    ...
    <div class="p-4">
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-wrap gap-2 mt-2">
          <BadgeButton v-for="category in editorStore.categories" :key="category" :value="category"
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-wrap gap-2 mt-2">
          <BadgeButton v-for="tag in editorStore.tags" :key="tag" :value="tag" :cb="editorStore.removeTag" />
        </div>
      </div>
      <!-- Word Count Stats -->
      <div class="mb-6">
