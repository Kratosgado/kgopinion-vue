        ...
        <div class="max-w-4xl px-4 text-center text-white">
          ...
          <div class="flex items-center justify-center gap-4 text-sm">
            <div class="flex items-center gap-2">
              <img :src="article.author?.avatar || '/favicon.ico'" :alt="article.author?.name"
        ...
        <div class="lg:col-span-2">
          ...
          <div class="mt-8 flex flex-wrap items-center justify-between border-t pt-6">
            ...
            <div class="mt-4 flex gap-2 sm:mt-0">
              <IconTwitter v-if="article.author?.social?.twitter" :link="article.author?.social?.twitter" />
              <IconGithub v-if="article.author?.social?.github" :link="article.author?.social?.github" />
              <IconLinkedIn v-if="article.author?.social?.linkedIn" :link="article.author?.social?.linkedIn" />
            </div>
          </div>
